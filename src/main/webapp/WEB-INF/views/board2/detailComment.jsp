...
<div class="container">
	...
	<div class="col-xs-12">
		<form action="/board2/insertProc" method="post">
			<dl class="dl-horizontal">
				...
				<dt>첨부파일</dt>
				<dd><a href="/board2/fileDown/${files.bno}">${files.fileOriName}</a></dd>
		...
		<div class="btn-group btn-group-sm" role="group" style="float:right;">
			<button type="button" class="btn btn-info"    onclick="location.href='/board2/delete/${detail.bno}'">삭제</button>
			<button type="button" class="btn btn-success" onclick="location.href='/board2/update/${detail.bno}'">수정</button>
			<button type="button" class="btn btn-danger " onclick="location.href='/board2/list'">목록</button>
		</div>
	</div>
