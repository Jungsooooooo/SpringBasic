	...
	<form class="form-horizontal" method="post" action="/member/login" id="loginForm">
		...
		<c:if test="${member == null}">
			...
			<div class="form-group">
				...
				<div class="col-sm-3">
					<input type="text" class="form-control" id="userId" name="id" maxlength="16" placeholder="아이디를 입력하세요."/>
				</div>
			</div>
			...
			<div class="form-group">
				<div class="col-sm-offset-2 col-sm-6">
					...
					<button class="btn btn-info" type="button" id="registerBtn">회원가입</button>
		...
		<c:if test="${member != null}">
			<div class="form-group">
				<div class="col-sm-offset-2 col-sm-6">
					<div class="jumbotron">
						<h2 align="center">${member.id} ${member.name}님 환영합니다.</h2>
					</div>
				</div>
			</div>
			<div class="form-group">
				<div class="col-sm-offset-3 col-sm-4">
					<input type="hidden" id="userId" name="id"  value="${member.id}"/>
		...
		<c:if test="${msg == false}">
			...
			<div class="form-group">
				<div class="col-sm-8">
					<div style="background-color:#CF0; color:red;"><h4>로그인을 실패하였습니다. 아이디와 비밀번호를 확인하신 후에 다시 하십시오.</h4></div>
				</div>
			</div>
		</c:if>
...
$(document).ready(function() {
	...
	$("#registerBtn").on("click", function() {
		location.href = "/member/registerAjax";
	});
